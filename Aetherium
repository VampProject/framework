...
function Library:CreateWindow(Config)
    ...
    local CloseBtn = createControlBtn(Color3.fromRGB(255, 95, 87), -34) -- Mac Red
    local MinBtn = createControlBtn(Color3.fromRGB(255, 189, 46), -68) -- Mac Yellow
    local MaxBtn = createControlBtn(Color3.fromRGB(40, 201, 64), -102) -- Mac Green (Visual)
    ...
    FloatingWidget.Size = UDim2.new(0, 250, 0, 60)
    ...
    MaximizeBtn.Image = "rbxassetid://449042257" -- Icono personalizable
    MaximizeBtn.Size = UDim2.new(0, 40, 0, 40)
    MaximizeBtn.Position = UDim2.new(1, -50, 0.5, -20)
    ...
    local function ToggleMinimize()
        ...
        FloatingWidget.Size = UDim2.new(0, 0, 0, 60)
        TweenService:Create(FloatingWidget, TweenInfo.new(0.5, Enum.EasingStyle.Elastic, Enum.EasingDirection.Out), {Size = UDim2.new(0, 250, 0, 60)}):Play()
    end

    MaximizeBtn.MouseButton1Click:Connect(function()
        TweenService:Create(FloatingWidget, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Size = UDim2.new(0, 0, 0, 60)}):Play()
        task.wait(0.3)
        FloatingWidget.Visible = false
